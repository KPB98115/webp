        ...
        const profile_template = (
            <div id="profile_block_bg" onClick={()=>{setProfile()}}>
                <div id="profile_container" onClick={(event)=>{event.stopPropagation()}}>
                    <div id="profile_info">
                        <div className="profile_title">Username: <p id="profile_username" style={{color: "black"}}>{props.user.displayName}</p></div>
                        <div className="profile_title">Email address: <p id="profile_email" style={{color: "black"}}>{props.user.email}</p></div>  
